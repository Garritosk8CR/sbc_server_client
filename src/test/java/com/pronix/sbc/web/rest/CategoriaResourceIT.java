...
public class CategoriaResourceIT {
    ...
    public void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.getEtiqueta()).isEqualTo(DEFAULT_ETIQUETA);
    }
    ...
    public void updateCategoria() throws Exception {
        ...
        assertThat(testCategoria.getEtiqueta()).isEqualTo(UPDATED_ETIQUETA);
    }
